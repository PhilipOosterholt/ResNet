...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        # If the model has 4 layers, use residual
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # Make layer 3 and 4 for ResNet 10 and higher
        ...
        # Match in and out features to linear layer
        if layers[3] is 0 and layers[2] is not 0:
...
def resnet6(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet18', BasicBlock, [1, 1, 0, 0], pretrained, progress,
                   **kwargs)
